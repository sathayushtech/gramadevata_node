...
import { VillageSchoolsService } from './village-schools.service';

@Controller('gramadevata/village_school')
@ApiTags('Village Schools')
export class VillageSchoolsController {
  constructor(private readonly service: VillageSchoolsService) {}
