...
import { VillageCulturalProfileService } from './village-cultural-profile.service';

@Controller('gramadevata/village-cultural-profile')
@ApiTags('Village Cultural Profile')
export class VillageCulturalProfileController {
  constructor(private readonly service: VillageCulturalProfileService) {}
