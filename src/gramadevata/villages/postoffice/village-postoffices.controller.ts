...
import { VillagePostOfficesService } from './village-postoffices.service';

@Controller('gramadevata/village-postoffice')
@ApiTags('Village Post Office')
export class VillagePostOfficesController {
  constructor(private readonly service: VillagePostOfficesService) {}
