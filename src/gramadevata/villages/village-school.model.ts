...
@Table({ tableName: 'village_school', timestamps: false })
export class VillageSchool extends Model<VillageSchool> {
  @Column({
    type: DataType.UUID,
    allowNull: false,
    primaryKey: true,
  ...
  @Column({ type: DataType.STRING(45), allowNull: true, defaultValue: SchoolType.PRIVATE, field: 'school_type', validate: { isIn: [Object.values(SchoolType)] } })
