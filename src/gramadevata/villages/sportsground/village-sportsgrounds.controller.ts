...
import { VillageSportsgroundsService } from './village-sportsgrounds.service';

@Controller('gramadevata/village-sportsground')
@ApiTags('Village Sportsground')
export class VillageSportsgroundsController {
  constructor(private readonly service: VillageSportsgroundsService) {}
