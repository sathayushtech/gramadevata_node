...
import { VillageMarketsService } from './village-markets.service';

@Controller('gramadevata/village-market')
@ApiTags('Village Markets')
export class VillageMarketsController {
  constructor(private readonly service: VillageMarketsService) {}
