...
import { VillageCollegesService } from './village-colleges.service';

@Controller('gramadevata/village-college')
@ApiTags('Village Colleges')
export class VillageCollegesController {
  constructor(private readonly service: VillageCollegesService) {}
