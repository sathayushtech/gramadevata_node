...
export class AddMoreHotel extends Model<AddMoreHotel> {
  ...
  @Column({ type: DataType.STRING(45), allowNull: true, defaultValue: EntityStatus.INACTIVE, field: 'status', validate: { isIn: [Object.values(EntityStatus)] } })
  declare status?: string;

  @Column({ type: DataType.DATE(6), allowNull: true, field: 'created_at' })
