...
export class Event extends Model<Event> {
  ...
  @Column({ type: DataType.STRING(50), allowNull: true, field: 'tag' })
  declare tag?: string;
  ...
  @Column({ type: DataType.STRING(50), allowNull: true, field: 'event_status' })
  ...
  @Column({ type: DataType.STRING(20), allowNull: true, field: 'food' })
  declare food?: string;

  @Column({ type: DataType.STRING(20), allowNull: true, field: 'water' })
  declare water?: string;

  @Column({ type: DataType.STRING(20), allowNull: true, field: 'toilets' })
