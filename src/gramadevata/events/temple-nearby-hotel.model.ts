...
export class TempleNearbyHotel extends Model<TempleNearbyHotel> {
  ...
  @Column({ type: DataType.STRING(100), allowNull: true, field: 'hotel_rating' })
  declare hotelRating?: string;
  ...
  @Column({ type: DataType.STRING(10), allowNull: true, field: 'email_id' })
