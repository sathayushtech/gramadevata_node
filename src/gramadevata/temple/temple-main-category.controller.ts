...
@Controller('gramadevata/temple_main_category')
@ApiTags('temple_main_category')
export class TempleMainCategoryController {
  constructor(private readonly service: TempleMainCategoryService) {}
